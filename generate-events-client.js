// Script de génération d'événements utilisant l'API Firebase côté client
// Ce script fonctionne avec les clés Firebase déjà configurées dans l'app

const { initializeApp } = require('firebase/app');
const { getFirestore, collection, addDoc, serverTimestamp } = require('firebase/firestore');

// Configuration Firebase (utilise les mêmes clés que l'app)
